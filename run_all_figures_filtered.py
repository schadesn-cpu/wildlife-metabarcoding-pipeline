...
Usage (run from project root):
    python scripts/run_all_figures_filtered.py [--dry-run]
    python scripts/run_all_figures_filtered.py --markers 16S MiFish
    python scripts/run_all_figures_filtered.py --analyses DvT COD
    python scripts/run_all_figures_filtered.py --config /path/to/pipeline_config.yml
