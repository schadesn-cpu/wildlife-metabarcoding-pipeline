...
def build_parser() -> argparse.ArgumentParser:
    """Build and return the argument parser for 01_make_manifests.py."""
...
def main(argv: Optional[List[str]] = None) -> int:
    """
Parse arguments, discover R1/R2 pairs in the reads directory, and write
    one QIIME2 PairedEndFastqManifestPhred33V2 TSV per marker to outdir.

    Returns 0 on success, 1 on any error (missing directory, unpaired files,
    no reads found). Dry-run mode prints what would be written without creating
    any files.
    """
